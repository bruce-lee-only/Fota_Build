...
public class BomInfo implements IBomDetail {
    ...
    public SlaveDownloadAgent.InfoReq infoReq;
    ...
    private SlaveDownloadAgent.InstallReq.BusType getInstallBusType() {
        switch (busType) {
            case BUS_TYPE_CAN:
                return SlaveDownloadAgent.InstallReq.BusType.CAN;
            case BUS_TYPE_ETHERNET:
                return SlaveDownloadAgent.InstallReq.BusType.ETHERNET;
            case BUS_TYPE_FLEXRAY:
                return SlaveDownloadAgent.InstallReq.BusType.FLEXRAY;
            case BUS_TYPE_LIN:
                return SlaveDownloadAgent.InstallReq.BusType.LIN;
        }
        return SlaveDownloadAgent.InstallReq.BusType.UNKNOWN;
    }
