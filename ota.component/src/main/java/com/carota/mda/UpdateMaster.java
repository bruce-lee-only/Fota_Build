...
public class UpdateMaster {
    ...
    public UpdateMaster(Context context, ISecuritySolution solution,
        ...
        mParamConfig = cfg.get(ParamConfig.class);
            ...
            if (!TextUtils.isEmpty(vd.getVin())) {
                ...
                if (null != joResp && joResp.has(UpdateCampaign.PROP_VIN)) {
                    ...
                    if (mSession.check()) {
                        ...
                        ConfigManager.syncPreConfig(mParamConfig.getConfigUrl(), vd.getVin(), mParamConfig.getMaxRetry());
                        ConfigManager.syncConfig(mParamConfig.getConfigUrl(), vd.getVin(), mSession.getScheduleId(), mParamConfig.getMaxRetry());
