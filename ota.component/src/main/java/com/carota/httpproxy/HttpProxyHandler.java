...
public class HttpProxyHandler extends SimpleHandler {
    ...
    public HttpProxyHandler(String[] whiteList) {
    ...
    public HttpResp post(String path, Map<String, List<String>> params,
        ...
        try {
            ...
            Logger.warn(TAG + "url = " + url);

            if (!isProxyUrl(mWhiteList, url)) {
                return HttpResp.newInstance(
                        PrivStatusCode.SRV_ACT_UNKNOWN,
    ...
    public static boolean isProxyUrl(String[] whiteList, String url) {
